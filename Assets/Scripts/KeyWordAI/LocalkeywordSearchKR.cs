...
public class LocalKeywordSearchKR : MonoBehaviour
{
    ...
    public void OnSearchButtonClick()
    {
        ...
        if (bestMatch != null)
        {
            resultText.text = "가장 유사한 키워드: " + bestMatch;
        }
        else
        {
            resultText.text = "유사한 키워드를 찾을 수 없습니다.";
        }
    }
